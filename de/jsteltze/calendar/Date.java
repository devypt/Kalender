...
//		this.set(Calendar.MILLISECOND, 0);
	...
	public static String month2String(int month, boolean Short) {
		if (month == Calendar.JANUARY)
			return (Short) ? Trans.t("Jan") : Trans.t("January");
		else if (month == Calendar.FEBRUARY)
			return (Short) ? Trans.t("Feb") : Trans.t("February");
		else if (month == Calendar.MARCH)
			return (Short) ? Trans.t("Mar") : Trans.t("March");
		else if (month == Calendar.APRIL)
			return (Short) ? Trans.t("Apr") : Trans.t("April");
		else if (month == Calendar.MAY)
			return Trans.t("May");
		else if (month == Calendar.JUNE)
			return (Short) ? Trans.t("Jun") : Trans.t("June");
		else if (month == Calendar.JULY)
			return (Short) ? Trans.t("Jul") : Trans.t("July");
		else if (month == Calendar.AUGUST)
			return (Short) ?Trans.t("Aug") : Trans.t("August");
		else if (month == Calendar.SEPTEMBER)
			return (Short) ? Trans.t("Sep") : Trans.t("September");
		else if (month == Calendar.OCTOBER)
			return (Short) ? Trans.t("Oct") : Trans.t("October");
		else if (month == Calendar.NOVEMBER)
			return (Short) ? Trans.t("Nov") : Trans.t("November");
		else if (month == Calendar.DECEMBER)
			return (Short) ? Trans.t("Dec"): Trans.t("December");
		else
			return "???";
	}
	...
	public static String dayOfWeek2String(int day, boolean Short) {
		if (day == Calendar.SUNDAY)
			return (Short) ? Trans.t("Su") : Trans.t("Sunday");
		else if (day == Calendar.MONDAY)
			return (Short) ? Trans.t("Mo") : Trans.t("Monday");
		else if (day == Calendar.TUESDAY)
			return (Short) ? Trans.t("Tu") : Trans.t("Tuesday");
		else if (day == Calendar.WEDNESDAY)
			return (Short) ? Trans.t("We") : Trans.t("Wednesday");
		else if (day == Calendar.THURSDAY)
			return (Short) ? Trans.t("Th") : Trans.t("Thursday");
		else if (day == Calendar.FRIDAY)
			return (Short) ? Trans.t("Fr") :Trans.t("Friday");
		else if (day == Calendar.SATURDAY)
			return (Short) ? Trans.t("Sa") : Trans.t("Saturday");
		else
			return "???";
	}
